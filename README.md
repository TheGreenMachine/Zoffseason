# Zoffseason
Zoffseason is FRC Team 1816's 2022 offseason training repositiory. This software uses Java 11, the [WPILib](https://github.com/wpilibsuite/allwpilib) library, and the [CTRE Phoenix](https://github.com/CrossTheRoadElec/Phoenix-api) library.
...
3. **Do NOT select 'Open Project'**. Instead, select 'Get from VCS' or 'import project'.
